/** @file
 * @brief Oblique Mercator (Hotine) - Forward Transformation
 *
 * PURPOSE: Transforms input longitude and latitude to Easting and
 *          Northing for the Oblique Mercator projection. The longitude and
...
/** 
 * Initialize the Oblique Mercator projection for forward transformation.
 * 
