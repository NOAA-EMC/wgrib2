...
int f_lvl(int mode, unsigned char **sec, float *data, unsigned int ndata, char *inv, void **local);
int f_match_inv(int mode, unsigned char **sec, float *data, unsigned int ndata, char *inv, void **local);
...
int f_set_lvl1(int mode, unsigned char **sec, float *data, unsigned int ndata, char *inv, void **local, const char *arg1);
int f_set_lvl2(int mode, unsigned char **sec, float *data, unsigned int ndata, char *inv, void **local, const char *arg1);
