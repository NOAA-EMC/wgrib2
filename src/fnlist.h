/** @file
 * @brief Header file with function prototypes for wgrib2 options. This file was generated by function.sh.
 * @author Public Domain: Wesley Ebisuzaki @date 2006
 */

/** Structure to hold function information for wgrib2 options. */
