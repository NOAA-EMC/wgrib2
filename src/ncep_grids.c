/** @file
 * @brief The option -new_grid handles several grids. This routine alters the arguments to 
 * -new_grid which are in the form "ncep grid XXX" to one of the generic definitions 
 * understood by -new_grid.
 * @author Public Domain: Wesley Ebisuzaki @date 5/2010
 */
 ...
 *
 * @param arg1  The first argument (should be "ncep")
 * @param arg2  The second argument (should be "grid")
 * @param arg3  The third argument (the specific grid name)
 *
 * @author Wesley Ebisuzaki @date 5/2010
 */
