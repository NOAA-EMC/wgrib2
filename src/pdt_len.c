/** @file
 * @brief Get expected size of product definition template (PDT).
 * 
 ...
 * @author Public Domain: Wesley Ebisuzaki @date 2/2022
 */
 ...
 *
 * For generating a new PDT, the minimum size is returned.
 *
 * @param sec Pointer to GRIB sections. If not NULL, returns expected size of PDT. If NULL, 
 * return minimum size of PDT.
 * @param pdt Product Definition Template (PDT) number.
 * 
 * @return Expected size of PDT, 0 for illegal value, -1 for unrecognized PDT.
 *
 * @author Wesley Ebisuzaki @date 2/2022
 */
