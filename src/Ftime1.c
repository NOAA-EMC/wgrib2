/** @file
 * @brief Implementation for -ftime1 and helper functions. The -ftime1 option is the 
 * older version of -ftime2 and will be removed in future releases.
 * 
 * ### Program History Log
 ...
 * 07/2009 | Reinoud Bokhorst | Bug fix (buffer overflow)
 * 
...
/**
 * Write time information to a string.
 * 
 * @param unit The unit of time.
 * @param value The value of time.
 * @param inv_out Pointer to the inventory output.
 * 
...
/**
 * Prints formatted forecast time stamp (ftime).
 * 
 * @param unit1 The unit of the first time.
 * @param value1 The value of the first time.
 * @param unit2 The unit of the second time.
 * @param value2 The value of the second time.
 * @param format The format of the output.
 * If format == 1, only print out 1st time.
 * If format == 2, print out 1st - (1st + 2nd) times.
 * @param inv_out Pointer to the inventory output.
 * 
 * @author Wesley Ebisuzaki @date 2006
 */
...
/**
 * Prints statistical information for the time ranges.
 * 
 * @param mode The mode of operation.
 * @param sec Pointer to the GRIB2 section.
 * @param inv_out Pointer to the inventory output.
 * @param p Pointer to location of number of time range specifications
 * @param inner The inner flag.
 * 
 * @return 0 on success, -1 on failure.
 * 
 * @author Wesley Ebisuzaki @date 2006
...
/**
 * Prints the forecast time stamp. This is the old version of this routine and has
 * since been replaced by the -ftime2 routine because -ftime1 could not handle more 
 * complicated time stamps correctly. One should not use -ftime1. The -ftime2 routines 
 * will work with more complicated time stamps and are more powerful.
 * 
