/** @file
 * @brief Various integer conversion routines.
 * 
 * ### Program History Log
 * Date | Programmer | Comments
 * -----|------------|---------
 * 2006 | W. Ebisuzaki | Initial
 * 1/2007 | W. Ebisuzaki | uint8 fix
...
/**
 * Convert 2 byte integer from GRIB file to unsigned int.
 * 
 * @param p Pointer to grib data.
 *
...
/**
 * Convert 4 byte integer from GRIB file to unsigned int.
 * 
 * @param p Pointer to grib data.
 *
 * @return Unsigned int value.
...
/**
 * Check if the given GRIB data is missing (all bytes are 255).
 * 
 * @param p Pointer to grib data.
...
/**
 * Convert 4 byte integer from GRIB file to unsigned int if value is not missing.
 * 
 * Only used in Sec3.c where an undefined nx/ny == 0 is a good response.
 *
 * @param p Pointer to grib data.
 * 
 * @return 0 if missing, otherwise the unsigned int value.
 * 
 * @author Wesley Ebisuzaki @date 2006
 */
...
/**
 * Convert 8 byte integer from GRIB file to unsigned int.
 * 
 * @param p Pointer to grib data.
 *
 * @return Unsigned int value.
...
/**
 * Convert n byte integer from GRIB file to unsigned int.
 * 
 * @param p Pointer to grib data.
...
/**
 * Convert 1 byte integer from GRIB file to int.
 * 
 * @param p Pointer to grib data.
 * 
 * @return Int value.
...
/**
 * Convert 2 byte integer from GRIB file to int.
 * 
 * @param p Pointer to grib data.
 * 
 * @return Int value.
...
/**
 * Convert 4 byte integer from GRIB file to int.
 * 
 * @param p Pointer to grib data.
 * 
 * @return Int value.
...
/**
 * Convert n byte integer from GRIB file to int.
 * 
 * @param p Pointer to grib data.
 * @param n Number of bytes to convert.
 * 
...
/**
 * Convert 4 byte integer from GRIB file to int using 2's complement.
 * 
 * @param p Pointer to grib data.
 * 
 * @return Int value.
...
/**
 * Convert scaled integer to double.
 * 
 * @param scale_factor Scale factor.
 * @param scale_value Scale value.
 * 
...
/**
 * Pack scaled value into character array.
 * 
 * Scaled value is stored as p[0] = INT1(scale_factor), INT4(scale_value)
 * 
 * @param scale_factor Scale factor.
 * @param scale_value Scale value.
 * @param p Pointer to character array.
 * 
 * @author Wesley Ebisuzaki @date 2006
 */
...
/**
 * Find the best scaled value for a given double.
 * 
 * @param val Double value.
 * @param scale_factor Pointer to scale factor.
 * @param scale_value Pointer to scale value.
 * 
...
/**
 * Pack 8-byte unsigned integer into character array.
 * 
 * @param i 8-byte unsigned integer.
 * @param p Pointer to character array.
 * 
 * @author Wesley Ebisuzaki @date 2006
 */
...
/**
 * Pack unsigned integer into character array.
 * 
...
/**
 * Pack integer into character array.
 * 
 * @param i Integer.
 * @param p Pointer to character array.
 * 
...
/**
 * Pack 2-byte unsigned integer into character array.
 * 
 * @param i Unsigned integer.
 * @param p Pointer to character array.
 * 
...
/**
 * Pack 2-byte integer into character array.
 * 
 * @param i 2-byte integer.
 * @param p Pointer to character array.
 * 
 * @author Wesley Ebisuzaki @date 2006
 */
...
/**
 * Pack 1-byte integer into character array.
 * 
 * @param i 1-byte integer.
 * @param p Pointer to character array.
 * 
 * @author Wesley Ebisuzaki @date 2006
 */
 ...
 * of a variable size.
 *
 * To keep the output the same, this function returns a string variable.
 *
 * @param nx The value of nx.
 *
 * @return Pointer to the string representation of nx.
 * 
 * @author Wesley Ebisuzaki @date 2006
 */
 ...
 * To keep the output the same, this function returns a string variable.
 *
 * @param ny The value of ny.
 *
 * @return Pointer to the string representation of ny.
 * 
 * @author Wesley Ebisuzaki @date 2006
 */
...
/**
 * Get the sub-angle from the character array.
 *
 * Documentation does not say that subangle is unsigned, assumed signed.
 * 
 * @param p Pointer to the character array.
 *
 * @return The sub-angle value. If the value is 0, returns 1. If the value is undefined, returns 1e6.
 *
 * @author Wesley Ebisuzaki @date 2006
 */
...
/**
 * Check if the string represents an unsigned integer.
 * 
 * @param p Pointer to the string.
 * 
 * @return 1 if the string represents an unsigned integer, 0 if not.
 * 
 * @author Wesley Ebisuzaki @date 2006
 */
