/** @file
 * @brief Function list for wgrib2. This file was generated by function.sh.
...
struct function functions[] = {
   ...
   {"set_date",f_set_date, misc, 1, "changes date code, X=(+|-)N(mn|hr|dy|mo|yr), YYYYMMDDHHmmSS, u(UNIX TIME)", 100},
   ...
   {"set_ts_dates",f_set_ts_dates, misc, 3, "change date code for time series X=YYYYMMDDHH(mmss) Y=dtime Z=#msgs/date", 100},
