/** @file
 * @brief Defines Code Table 4.230. (Atmospheric chemical constituent type)
 * This file is generated by get_CCT14.sh.
 * @author Wesley Ebisuzaki @date 2009
 */

#include "wgrib2.h"

/** Struct for Code Table 4.230 (Atmospheric chemical constituent type) */
