...
../src/wgrib2 data/gdas.t12z.pgrb2.1p00.anl.75r.grib2 -match "(UGRD|VGRD)" -new_grid_winds grid  \
    -new_grid latlon 0:360:1 00:181:1 new_grid.grb
../src/wgrib2 new_grid.grb -grid -v2 > new_grid.txt
touch new_grid.txt
...
../src/wgrib2 new_grid_earth.grb -grid -v2 > new_grid_earth.txt
