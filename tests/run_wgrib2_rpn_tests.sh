...
../src/wgrib2 data/gdas.t12z.pgrb2.1p00.anl.75r.grib2 -match ":TMP:0.01" -rpn "273.15:-" -text celsius.txt
touch celsius.txt
diff -w celsius.txt data/ref_celsius.gdas.t12z.pgrb2.1p00.anl.75r.grib2.txt


echo "*** Converting temperatures from K to F"
../src/wgrib2 data/gdas.t12z.pgrb2.1p00.anl.75r.grib2 -match ":TMP:0.01" -rpn "273.15:-:9:*:5:/:32:+" -text fahrenheit.txt
touch fahrenheit.txt
diff -w fahrenheit.txt data/ref_fahrenheit.gdas.t12z.pgrb2.1p00.anl.75r.grib2.txt

echo "*** Takes relative humidity values, limits them to 100 and outputs to grib file"
../src/wgrib2 data/gdas.t12z.pgrb2.1p00.anl.75r.grib2 -match ":RH:" -if ":RH:" -rpn "100:min" -fi -grib_out rh.grb -not_if ":RH:" -grib rh.grb
../src/wgrib2 rh.grb > rh.txt
touch rh.txt
...
#../src/wgrib2 data/gdas.t12z.pgrb2.1p00.anl.75r.grib2 -for 1:25 -match ":(UGRD|VGRD):" \
...
# Check output
#../src/wgrib2 tmp_windspeed.grb -text tmp_windspeed.txt
#diff -w tmp_windspeed.txt data/ref_tmp_windspeed.txt

#../src/wgrib2 tmp_windspeed.grb -rpn print_min -rpn print_max -rpn print_ave > min_max_ave_windspeed.txt
