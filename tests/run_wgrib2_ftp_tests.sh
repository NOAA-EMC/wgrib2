...
../src/wgrib2 data/WW3_Regional_US_West_Coast_20220718_0000.grib2 > ftp_inv1.txt
cat ftp_inv1.txt
diff -w ftp_inv1.txt data/ref_WW3_Regional_US_West_Coast_20220718_0000.grib2.inv

echo "*** Testing merge_fcst"
../src/wgrib2 data/aqm.t12z.max_8hr_o3.227.grib2 -merge_fcst 3 merge.grb
../src/wgrib2 merge.grb > merge.txt
cat merge.txt
